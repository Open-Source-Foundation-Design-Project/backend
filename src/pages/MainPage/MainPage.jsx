    ...
    >
      ...
      <div className="p-20">
        ...
        <div className="p-20 flex justify-center gap-8">
          <div
            onClick={Search}
            className="rounded-xl border bg-[#D9FAFF] w-36 h-36 flex flex-col items-center justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p className="text-center text-sm font-medium">여행 추천</p>
          </div>

          <div
            onClick={PlanPage}
            className="rounded-xl border bg-[#FFD1D1] w-36 h-36 flex flex-col items-center justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p className="text-center text-sm font-medium">여행 계획</p>
          </div>

          <div
            onClick={StoryPage}
            className="rounded-xl border bg-[#D8FFD8] w-36 h-36 flex flex-col items-center justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p className="text-center text-sm font-medium">커뮤니티</p>
          </div>

          <div
            onClick={MyPage}
            className="rounded-xl border bg-[#F9FFDF] w-36 h-36 flex flex-col items-center justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
